...
The workflow then extracts the `.text` section size from both `cargo bloat` outputs, calculates the percentage change, and creates a commit status that appears inline in the PR's checks list.
